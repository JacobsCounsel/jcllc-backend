...
// Enhanced email templates will be directly implemented below

// ==================== EMAIL TEMPLATES (Enhanced versions with better formatting and disclaimers) ====================
...
<body style="font-family: 'SF Pro Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 0; padding: 20px; background-color: #f8fafc; color: #1f2937; line-height: 1.6;">
...
<body style="font-family: 'SF Pro Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 0; padding: 20px; background: #f8fafc; color: #1f2937; line-height: 1.5;">
...
export function generateInternalAlertOld(formData, leadScore, submissionType, aiAnalysis, submissionId) {
